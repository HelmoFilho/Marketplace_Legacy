...
-- Verificando se as tabelas temporarias existem
...
FROM
    ...
    LEFT JOIN (
					...
					FROM
						...
						INNER JOIN #HOLD_ID_PRODUTO thip ON
                            op.id_produto = thip.id_produto
							AND o.id_distribuidor = thip.id_distribuidor
    ...
    (
		...
		FROM
			...
			INNER JOIN #HOLD_ID_PRODUTO thip ON
				offers_produto.id_produto = thip.id_produto
